...
public class TestUriMatcher extends AndroidTestCase {
    ...
    public void testUriMatcher() {
        ...
        Log.d(LOG_TAG, "TEST_WEATHER_DIR : " + TEST_WEATHER_DIR.toString());
        Log.d(LOG_TAG, "TEST_WEATHER_WITH_LOCATION_DIR : " + TEST_WEATHER_WITH_LOCATION_DIR.toString());
        Log.d(LOG_TAG, "TEST_WEATHER_WITH_LOCATION_AND_DATE_DIR : " + TEST_WEATHER_WITH_LOCATION_AND_DATE_DIR.toString());
        Log.d(LOG_TAG, "TEST_LOCATION_DIR : " + TEST_LOCATION_DIR.toString());
